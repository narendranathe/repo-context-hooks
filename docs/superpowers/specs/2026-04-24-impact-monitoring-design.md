...
The feature should answer three questions:
...
`measure_impact()` reads local JSONL events and current repo-contract signals, then renders a human or JSON report.
