...
This is repo-safe OpenClaw persona guidance for this repository.

- Treat the repo as the continuity source of truth.
- Read `README.md` for public product intent.
